...
alias autheliad=' podman run --rm -v ~/momopod/app/authelia/config:/config -v ~/momopod/app/authelia/secrets:/secretsdocker.io/authelia/authelia authelia'
##################################################
#         aliases games
