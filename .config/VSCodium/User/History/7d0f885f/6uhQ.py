...
class SeleniumHelper:
	...
	def __init__(self, driverType=None, PROXY_PORT=1271):
		self.driverType = driverType
		if driverType == 'proxy':
			profile = webdriver.FirefoxProfile(profile_directory=r".\Profiles\Xprofile1")
			...
			profile = webdriver.FirefoxProfile(profile_directory=r"C:\Users\I7-8700\AppData\Roaming\Mozilla\Firefox\Profiles\Ankerfox.js")
			firefox_options = webdriver.FirefoxOptions()
			#firefox_options.headless = True #Headless
			firefox_options.profile = profile
