...
do
    case $opt in
        ...
        "Farthest Frontier"
            ...
            SteamAppId=1044720 STEAM_COMPAT_DATA_PATH=/media/Nvme_Data/proton/compatdata/ STEAM_COMPAT_CLIENT_INSTALL_PATH=/ offline /media/Nvme_Data/proton/GE-Proton7-41/proton waitforexitandrun Subnautica.exe
            ;;
        "Quit")
            break
            ;;
