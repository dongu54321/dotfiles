class AIChatApp {
    ...
    initializeElements() {
        ...
        this.toggleSidebarBtn = document.getElementById('toggleSidebarBtn'); // Added
        this.sidebar = document.querySelector('.sidebar'); // Added
    ...
    bindEvents() {
        ...
        this.toggleSidebarBtn.addEventListener('click', () => this.toggleSidebar()); // Added
    }
    toggleSidebar() {
